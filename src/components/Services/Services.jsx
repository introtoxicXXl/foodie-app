...
const Services = () => {
    ...
    return (
        <div className="min-h-screen w-11/12 mx-auto">
            <div className="flex justify-between lg:flex-row flex-col mt-12">
                <div className="p-5 flex-1 space-y-10">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-5 flex-1">
                    {
